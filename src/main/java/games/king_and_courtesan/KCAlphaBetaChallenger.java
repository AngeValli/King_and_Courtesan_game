/*Class implementing a challenger to play King and Courtesan game based on alpha-beta pruning*/
...
public class KCAlphaBetaChallenger implements IChallenger {
	
	private static int depthMax = 6;
	...
	public void setRole(String role) {
		...
		IHeuristic<KCBoard, KCRole> hFriend = (roleFriend == KCRole.BLUE ? KCHeuristics.hBlue : KCHeuristics.hRed);
		
		GameAlgorithm<KCMove, KCRole, KCBoard> algFriend = new AlphaBetaTSTB<KCMove, KCRole, KCBoard>(
				roleFriend, roleEnemy, hFriend, depthMax);
